...
function Individual() {
  ...
  return (
    <main className="flex flex-col items-center gap-5  bg-accbg w-full min-h-screen">
      <h1 className="text-3xl md:text-4xl lg:text-5xl text-center text-acc5 font-bold p-6">
        {recipe.strMeal}
      </h1>
      {/* Information items */}
      <div className="flex justify-between items-end w-60">
        ...
        <div className="relative flex flex-col items-center w-20">
          ...
          <p className="absolute top-3 -left-1 text-[9px] uppercase font-bold">Location</p>
          <p className="text-xl text-acc4 font-bold whitespace-nowrap">{recipe.strArea}</p>
        </div>
      </div>
